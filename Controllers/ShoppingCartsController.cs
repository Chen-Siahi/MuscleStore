...
namespace MuscleStore.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public ShoppingCartsController(MuscleStoreContext context)
        {
            _context = context;
        }
        ...
        private ShoppingCart GetShoppingCart()
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///
        ///                                                        GetShoppingCart Using Sessio
        ///                                                  
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        //Returns customer ShoppingCart (according to his sessionID), If don't have one: create one! (unique for every session!!)
        /*
        private ShoppingCart GetShoppingCart()
        {
            //Lookin in the DB for ShoppingCart with the same SessionID
            var customerShoppingCart = _context.ShoppingCart.FirstOrDefault(i => i.AccountSessionID == HttpContext.Session.Id);

            if (customerShoppingCart == null) //not exsited -> lets create!
            {
                //create ShoppingCart
                customerShoppingCart = new ShoppingCart { AccountSessionID = HttpContext.Session.Id, DateCreated=DateTime.Now, LastModified=DateTime.Now };
                _context.ShoppingCart.Add(customerShoppingCart);

                //Saves the fact we created one(need to initialize  HttpContext.Session so session.id will stay fixed)
                HttpContext.Session.SetString("session", HttpContext.Session.Id);
            }
            customerShoppingCart.LastModified = DateTime.Now;
            _context.SaveChanges();
            return customerShoppingCart;
