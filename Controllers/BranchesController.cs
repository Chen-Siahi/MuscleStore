...
namespace MuscleStore.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public BranchesController(MuscleStoreContext context)
        {
            _context = context;
        }
        ...
        {
            List<Branch> list = _context.Branch.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,City")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
