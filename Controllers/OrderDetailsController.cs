...
namespace MuscleStore.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(MuscleStoreContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UnitPrice,Quantity")] OrderDetail orderDetail)
        {
